...
if (process.env.NODE_ENV != 'test')
{
	(async () => {
		...
		//await listBranches(userId, "Homework1");
		//await createRepo(userId,"Labs");
		//await createIssue(userId, "Labs", "Test Issue 2", "Test issue Body");
		await enableWikiSupport(userId,"Labs");
...
async function createRepo(owner,repo)
{
	...
	options.json = {
		"name" : repo,
		"description" : "Creating a Github repo from curl requests"
	}
